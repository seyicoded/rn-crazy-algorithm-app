  ...
  return (
    <NavigationContainer>
        <StackNav.Navigator>
            ...
            <StackNav.Screen name="Advance_number" options={{title: 'Number Advance Section', headerStyle: {backgroundColor: 'darkblue', color: 'white'}, headerTitleStyle: {color: 'white'}}} component={Advance_number} />
        </StackNav.Navigator>
    </NavigationContainer>
  )
}