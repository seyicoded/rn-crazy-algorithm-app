                ...
                >
                    <View>
                        ...
                        <Text style={{fontSize: 12}}>
                            {`Given an array A of integers and integer K, return the maximum S such that there exists ¡ < j with A] + AU) = S and S < K. If no such i, j exist satisfying this equation, return •1.`}
