...
export default function TuringTest2() {
    ...
    const calculate = async() => {
        try{
            ...
            var missing = null;
            if(parseInt(d) == 1){
                missing = ( parseInt(array[missing_index - 1]) + 1  );
            }else{
                missing = ( a + ((missing_index + 1) * d) );
            }
                ...
                >
                    <View>
                        ...
                        <Text style={{fontSize: 12}}>
                            {`Suppose you're given a set which originally contains numbers from 1 to n on A.P. Unfortunately, due to a data error,
